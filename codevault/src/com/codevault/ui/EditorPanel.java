...
public class EditorPanel extends JPanel {
    ...
    private static final Color EDITOR_BG     = new Color(0x1E, 0x1E, 0x1E);
    private static final Color EDITOR_FG     = new Color(0xD4, 0xD4, 0xD4);
    private static final Color GUTTER_BG     = new Color(0x25, 0x25, 0x26);
    private static final Color GUTTER_FG     = new Color(0x85, 0x85, 0x85);
    private static final Color CARET_COLOR   = new Color(0xFF, 0xFF, 0xFF);
    private static final Color SELECTION_BG  = new Color(0x26, 0x4F, 0x78);
    ...
    private void initUI() {
        ...
        // Style the scrollbars to be dark
    ...
    private JPanel buildTabBar() {
        ...
        bar.setBackground(new Color(0x25, 0x25, 0x26));
        bar.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(0x3C, 0x3C, 0x3C)));

        JLabel tab = new JLabel("  Main.java  ");
        tab.setForeground(new Color(0xD4, 0xD4, 0xD4));
        tab.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        tab.setBorder(BorderFactory.createMatteBorder(2, 0, 0, 1, new Color(0x00, 0x78, 0xD4)));
        tab.setOpaque(true);
        tab.setBackground(new Color(0x1E, 0x1E, 0x1E));
    ...
    /** Makes a JScrollBar use a dark, minimal look. */
    private void styleScrollBar(JScrollBar bar) {
        bar.setBackground(new Color(0x1E, 0x1E, 0x1E));
        bar.setForeground(new Color(0x42, 0x42, 0x42));
