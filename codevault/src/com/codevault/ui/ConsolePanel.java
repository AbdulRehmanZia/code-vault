...
public class ConsolePanel extends JPanel {
    ...
    private static final Color CONSOLE_BG  = new Color(0x1E, 0x1E, 0x1E);
    private static final Color CONSOLE_FG  = new Color(0xCC, 0xCC, 0xCC);
    private static final Color HEADER_BG   = new Color(0x25, 0x25, 0x26);
    private static final Color HEADER_FG   = new Color(0x9D, 0x9D, 0x9D);
    ...
    private void initUI() {
        ...
        setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, new Color(0x3C, 0x3C, 0x3C)));
    ...
    private JPanel buildHeader() {
        ...
        consoleTab.setForeground(new Color(0xD4, 0xD4, 0xD4));
